function [dfhat, muhat, chat, iters] = titer(x,useML,TOL)
...
if nargin==1, useML=1; TOL=1e-5;
elseif nargin==2, TOL=1e-5;
end
...
%TOL=1e-5; 
MAXCNT=100; conv=0; cnt=0; opts=optimset('disp','none','TolX',TOL);
